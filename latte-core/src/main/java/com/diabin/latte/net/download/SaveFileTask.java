...
public class SaveFileTask extends AsyncTask<Object, Integer, File> {
    ...
    protected File doInBackground(Object... params) {
        ...
        if(name==null){
            // 总大小,下载进度回调
            return FileUtil.writeToDisk(is,downloadDir,extension.toUpperCase(),extension,fileLength,writeToDiskCallBack);
        }else{
            return FileUtil.writeToDisk(is,downloadDir,name,fileLength,writeToDiskCallBack);
        }
    }
